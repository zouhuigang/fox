...
(function(b) {
    var m, u, x, g, D, i, z, A, B, p = 0, e = {}, q = [], n = 0, c = {}, j = [], E = null, s = new Image, G = /\.(jpg|gif|png|bmp|jpeg)(.*)?$/i, S = /[^\.]\.(swf)\s*$/i, H, I = 1, k, l, h = false, y = b.extend(b("<div/>")[0], {prop: 0}), v = 0, O = !b.support.opacity && !window.XMLHttpRequest, J = function() {
        ...
        if (e.modal) {
            e.overlayShow = true;
            e.hideOnOverlayClick = true;
            e.hideOnContentClick = false;
            e.enableEscapeButton = true;
            ...
            if (b.isArray(a)) {
                for (var f = 0, o = a.length; f < o; f++)
                    if (typeof a[f] ==
                        ...
                        a[f] = b({}).data("fancybox", b.extend({content: a[f]}, d));
                q = jQuery.merge(q, a)
            } else {
                if (typeof a == "object")
                    b(a).data("fancybox", b.extend({}, d, a));
                else
                    a = b({}).data("fancybox", b.extend({content: a}, d));
                q.push(a)
            }
            if (p > q.length || p < 0)
                p = 0;
    ...
    b.fancybox.close = function() {
        ...
        if (!(h || g.is(":hidden"))) {
            ...
            if (c.transitionOut == "elastic") {
                ...
                g.fadeOut(c.transitionOut == "none" ? 0 : c.speedOut, a)
        }
    };
