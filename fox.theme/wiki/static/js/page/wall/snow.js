(function() {
	...
	function i(a) {
		...
		this.left = Math.random() * this.maxLeft-50;
		this.top = h().top + 1;
	...
	i.prototype = {
		createEl: function(a, b) {
			...
			this.el.setAttribute("src", b + "/static/images/snow/snow" + Math.floor(Math.random() * 3) + ".gif");
		...
		draw: function() {
			...
			this.el.style.left = (Math.round(this.left)-30) + "px"
		},
		remove: function() {
